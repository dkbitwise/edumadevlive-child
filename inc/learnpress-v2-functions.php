                                    ...
                                    <div class="course-meta">
										...
										<?php if ( $price = $course->get_price_html() ) {
											...
											if ( $course->is_free() || ! $is_required ) {
												$class .= ' free-course';
												$price = esc_html__( 'Susbcribe', 'eduma' );
											}
                        ...
                        <div class="thim-carousel-wrapper thim-course-carousel thim-course-grid" data-visible="4"
                            ...
                            <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                                ...
                                <div class="course-item">
                                    ...
                                    echo thim_get_feature_image( get_post_thumbnail_id( get_the_ID() ), 'full', apply_filters( 'thim_course_thumbnail_width', 450 ), apply_filters( 'thim_course_thumbnail_height', 450 ), get_the_title() );
                                    echo '</a>';
