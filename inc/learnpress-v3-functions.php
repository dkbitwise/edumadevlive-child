...
if ( ! function_exists( 'thim_add_course_meta' ) ) {
	function thim_add_course_meta( $meta_box ) {
		...
		$fields[]           = array(
			'name' => esc_html__( 'Grade', 'eduma' ),
			'id'   => 'thim_course_grade',
			'type' => 'text',
			'desc' => esc_html__( 'Grade', 'eduma' ),
			'std'  => esc_html__( 'Grade', 'eduma' )
		);
...
if ( ! function_exists( 'thim_course_info' ) ) {
	function thim_course_info() {
		...
		?>
        <div class="thim-course-info test">
            ...
            <ul>
				...
				<?php if ( ! empty( $course_language ) ): ?>
                    <li class="language-feature">
                        ...
                        <span class="label"><?php esc_html_e( 'Languages', 'eduma' ); ?></span>
	...
	function thim_courses_collection_breadcrumb() {
		...
		if ( is_single() ) {
			if ( get_post_type() == 'lp_collection' ) {
				echo '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_post_type_archive_link( 'lp_collection' ) ) . '" title="' . esc_attr__( 'Tracks', 'eduma' ) . '"><span itemprop="name">' . esc_html__( 'Tracks', 'eduma' ) . '</span></a></li>';
			}
			echo '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name" title="' . esc_attr( get_the_title() ) . '">' . esc_html( get_the_title() ) . 'sss</span></li>';
		} else {
			echo '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><span itemprop="name">' . esc_html__( 'Streams', 'eduma' ) . '</span></li>';
		}
