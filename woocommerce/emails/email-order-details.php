...
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				<th class="td" scope="col" style="text-align:center;"><?php esc_html_e( 'Package', 'woocommerce' ); ?></th>
				<!--<th class="td" scope="col" style="text-align:center;"><?php esc_html_e( 'Sessions', 'woocommerce' ); ?></th>-->
				<th class="td" scope="col" style="text-align:center;"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<?php
