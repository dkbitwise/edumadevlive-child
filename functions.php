               ...
               <?php /* <li class="students-feature">
                ...
                <li class="assessments-feature">
                    ...
                    <li style="border:none!important" class="skill-feature">
                        ...
                        //echo esc_html( $course_prerequisite ); 
                        ?></span>
                    </li>
                <?php endif; ?>
            </ul>
                                            ...
                                            <?php if ( $price = $course->get_price_html() ) {
                                                ...
                                                <div class="course-price" itemprop="offers" itemscope
                                                    ...
                                                    <div class="value<?php echo $class; ?>" itemprop="price">
                                                        ...
                                                        ?>
                                                        <?php echo $price; ?>
<a href="https://devlive.bitwise.academy/choose-plan/?courseid=<?php echo $course->get_id();?>" class="btn btn-md btn-default sp-btn pull-right ml">JOIN NOW</a>
                                                    </div>
...
function order_meta_customized_display( $item_id, $item, $product ){
 ...
 $useless = array(
 "_qty","_tax_class","_variation_id","_product_id","_line_subtotal","_line_total","_line_subtotal_tax","bookme"
...
function new_order_reply_to_admin_header( $headers = '', $id = '', $order ) {
    ...
    /*$headers .= 'Reply-to: ' . __('Administrator') . ' <' . get_option( 'admin_email' ) . ">\r\n";
    return $headers;*/
